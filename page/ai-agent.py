...
card_data = [
    ...
    {"title": "bolt.new：在浏览器中生成与调试应用程序",
        "link": "https://github.com/little51/bolt.new.local",
        "description": "ai-agent.sh bolt.new",
        "image_path": "https://gitclone.com/download1/ai-agent/bolt.new.png"},
